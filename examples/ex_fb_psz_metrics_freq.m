...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Script used to compute the metrics as a function of frequency for a PSZ 
...
for i=1:Neval
    ...
    % Display
    dispPSZ(['K: ',int2str(K{i}),' N: ',int2str(R{i})],2);

    % .......................... Compute filters ..........................
    % Setup filter bank
    FB = gdftFB_Class(K{i},R{i},Ip,mexFlag); 
    % Compute filters            
