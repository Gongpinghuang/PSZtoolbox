...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Script used to compare the performance of wPM-T, wPM-F, and wPM-S
% -------------------------------------------------------------------------
% Change path
cd('../');
% Initialize
...
solver     = {'exact',[]     ,'exact'};
% Legend for plots
lgnStr     = {'wPM-T','wPM-F','wPM-S'};
% Number of different evaluations 
Neval      = numel(algorithm);
...
for i=1:Neval
    ...
    % .......................... Compute filters ..........................
    % Setup filter bank
    if strcmp(algorithm{i},'wPM-S')
       FB = gdftFB_Class(K,R,Ip,mexFlag); 
    else
       FB = []; 
    end
    % Compute filters            
    g = computeFilters(algorithm{i},...
                       Ig,...
                       mod_delay,...
                       LSPref,...
                       beta_rel,...
